...
import com.dunglv.chat.mapper.ChatMessageMapper;
import com.dunglv.chat.repository.ChatMessageRepository;
...
public class ChatMessageService {
    ...
    private ChatMessageResponse toChatMessageResponse(ChatMessage chatMessage) {
        ...
        chatMessageResponse.setMe(userId.equals(chatMessage.getSender().getUserId())); //true nếu người gửi == người đang login
